      ...
      <div className="relative bg-white rounded-2xl shadow-2xl overflow-hidden transform hover:scale-[1.02] transition-transform duration-500">
        <div className="grid grid-cols-1 md:grid-cols-12">
          ...
          <div className="md:col-span-4 bg-gradient-to-br from-blue-600 to-blue-700 relative p-6">
            ...
            <div className="absolute -right-3 top-2/4 w-6 h-6 bg-gray-50 rounded-full animate-pulse" style={{ animationDelay: '0.2s' }}></div>
            <div className="absolute -right-3 top-3/4 w-6 h-6 bg-gray-50 rounded-full animate-pulse" style={{ animationDelay: '0.4s' }}></div>
            ...
            <div className="relative z-10">
              ...
              <div className="space-y-4">
                <div className="transform hover:translate-x-1 transition-transform duration-300">
                  <p className="text-xs text-white/70 uppercase font-bold mb-1">From</p>
                ...
                <div className="transform hover:translate-x-1 transition-transform duration-300">
                  <p className="text-xs text-white/70 uppercase font-bold mb-1">To</p>
              ...
              <div className="mt-6 pt-4 border-t border-white/20 space-y-2">
                <div className="flex justify-between items-center group hover:bg-white/10 px-2 py-1 rounded transition-colors duration-300">
                  <span className="text-xs text-white/70 uppercase font-bold">Travelers</span>
                  <span className="text-lg font-black text-white group-hover:scale-110 transition-transform duration-300">500+</span>
                </div>
                <div className="flex justify-between items-center group hover:bg-white/10 px-2 py-1 rounded transition-colors duration-300">
                  <span className="text-xs text-white/70 uppercase font-bold">Destinations</span>
                  <span className="text-lg font-black text-white group-hover:scale-110 transition-transform duration-300">50+</span>
                </div>
                <div className="flex justify-between items-center group hover:bg-white/10 px-2 py-1 rounded transition-colors duration-300">
                  <span className="text-xs text-white/70 uppercase font-bold">Support</span>
                  <span className="text-lg font-black text-white group-hover:scale-110 transition-transform duration-300">24/7</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="md:col-span-8 p-6 md:p-8 bg-white">
            <div className="mb-4">
              <h2 className="text-2xl font-black text-gray-900 mb-1">Raj Tourism</h2>
              <p className="text-xs text-gray-500 uppercase font-bold tracking-wide">Your Travel Partner Since 2014</p>
            </div>

            <div className="prose prose-gray max-w-none mb-5">
              <p className="text-sm text-gray-700 leading-relaxed mb-3">
                <span className="font-bold text-gray-900">Raj Tourism</span> is your trusted local travel specialist for Gujarat and all of India. We believe that travel is not just about visiting places—it's about experiencing cultures, creating memories, and discovering stories that last a lifetime.
              </p>

              <p className="text-sm text-gray-700 leading-relaxed">
                With over a decade of experience, we specialize in crafting personalized itineraries that showcase the best of Gujarat's heritage, India's diversity, and beyond.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3 mb-5">
              <div className="flex items-center gap-2 p-3 bg-blue-50 rounded-lg border border-blue-100 hover:shadow-md hover:-translate-y-1 transition-all duration-300 group">
                ...
                <div>
                  <p className="font-bold text-gray-900 text-xs leading-tight">Expert Guides</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2 p-3 bg-purple-50 rounded-lg border border-purple-100 hover:shadow-md hover:-translate-y-1 transition-all duration-300 group">
                ...
                <div>
                  <p className="font-bold text-gray-900 text-xs leading-tight">Tailored Trips</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2 p-3 bg-green-50 rounded-lg border border-green-100 hover:shadow-md hover:-translate-y-1 transition-all duration-300 group">
                ...
                <div>
                  <p className="font-bold text-gray-900 text-xs leading-tight">24/7 Support</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2 p-3 bg-orange-50 rounded-lg border border-orange-100 hover:shadow-md hover:-translate-y-1 transition-all duration-300 group">
                ...
                <div>
                  <p className="font-bold text-gray-900 text-xs leading-tight">Trusted</p>
                </div>
              </div>
            </div>
            ...
            <div className="pt-3 border-t border-gray-200">
              <p className="text-xs text-gray-500 font-mono">BOOKING ID: RT-GUJ-2024 | CLASS: PREMIUM</p>
            </div>
          </div>
        </div>
      </div>
