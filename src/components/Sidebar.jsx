...
export default function Sidebar({ open, onClose }) {
  ...
  return (
    <>
      ...
      <aside
        ref={panelRef}
        className={`fixed top-0 right-0 bottom-0 z-50 w-80 max-w-[85%] bg-gradient-to-b from-white via-blue-50/30 to-white shadow-2xl transform transition-all duration-500 ease-out ${
      ...
      >
        ...
        <div className="h-16 flex items-center justify-between px-6 border-b border-blue-100">
          ...
          >
            <svg
              className="w-5 h-5 text-blue-600 group-hover:rotate-90 transition-transform duration-300"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
        ...
        {/* Navigation Links */}
        <nav
          className="p-6 space-y-1 overflow-y-auto"
        ...
        >
          ...
          >
            ...
            <span className="text-base font-bold text-gray-800 group-hover:text-blue-600 transition-colors duration-200">
              Home
            </span>
            <svg
              className="w-5 h-5 text-gray-500 group-hover:text-blue-600 group-hover:translate-x-1 transition-all duration-200"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
          ...
          >
            ...
            <span className="text-base font-bold text-gray-800 group-hover:text-orange-600 transition-colors duration-200">
              India
            </span>
            <svg
              className="w-5 h-5 text-gray-500 group-hover:text-orange-600 group-hover:translate-x-1 transition-all duration-200"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
          ...
          >
            ...
            <span className="text-base font-bold text-gray-800 group-hover:text-green-600 transition-colors duration-200">
              Gujarat
            </span>
            <svg
              className="w-5 h-5 text-gray-500 group-hover:text-green-600 group-hover:translate-x-1 transition-all duration-200"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
          ...
          >
            ...
            <span className="text-base font-bold text-gray-800 group-hover:text-cyan-600 transition-colors duration-200">
              International
            </span>
            <svg
              className="w-5 h-5 text-gray-500 group-hover:text-cyan-600 group-hover:translate-x-1 transition-all duration-200"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
          ...
          >
            ...
            <span className="text-base font-bold text-gray-800 group-hover:text-purple-600 transition-colors duration-200">
              Our Services
            </span>
            <svg
              className="w-5 h-5 text-gray-500 group-hover:text-purple-600 group-hover:translate-x-1 transition-all duration-200"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
          ...
          >
            ...
            <span className="text-base font-bold text-gray-800 group-hover:text-pink-600 transition-colors duration-200">
              About Us
            </span>
            <svg
              className="w-5 h-5 text-gray-500 group-hover:text-pink-600 group-hover:translate-x-1 transition-all duration-200"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
          ...
          >
            ...
            <span className="text-base font-bold text-gray-800 group-hover:text-indigo-600 transition-colors duration-200">
              Payment QR
            </span>
            <svg
              className="w-5 h-5 text-gray-500 group-hover:text-indigo-600 group-hover:translate-x-1 transition-all duration-200"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
