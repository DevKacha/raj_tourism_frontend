...
const ExploreIndia = () => {
  ...
  const destinations = [
    ...
    },
    {
      id: 6,
      name: "Tamil Nadu",
      image: '../src/assets/default/default.jpg',
  ...
  return (
    <div id="explore-india-section" className="relative min-h-screen py-16 px-4 sm:px-6 lg:px-8 overflow-hidden bg-gradient-to-b from-white via-slate-50 via-50% to-slate-50">

      {/* Soft color glows */}
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute left-10 top-20 w-96 h-96 bg-orange-200/40 rounded-full blur-3xl animate-pulse" style={{ animationDuration: '4s' }} />
        <div className="absolute right-10 top-40 w-80 h-80 bg-blue-200/30 rounded-full blur-3xl animate-pulse" style={{ animationDuration: '5s', animationDelay: '1s' }} />
        <div className="absolute left-1/3 bottom-32 w-96 h-96 bg-purple-300/20 rounded-full blur-3xl animate-pulse" style={{ animationDuration: '6s', animationDelay: '2s' }} />
      </div>
      ...
      <div className="relative max-w-7xl mx-auto text-center mb-16 animate-fade-in">
        ...
        <p className="text-xl text-gray-800 max-w-3xl mx-auto leading-relaxed drop-shadow-sm">
          From the snow-capped Himalayas to the tropical beaches, discover the diverse beauty
          and rich culture of India's most enchanting destinations
        </p>
      </div>
            ...
            <div className="p-5">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2 text-orange-600 font-semibold text-sm hover:gap-3 transition-all duration-300">
                  Explore
                  <ArrowRight className={`w-4 h-4 transition-transform duration-300 ${hoveredCard === destination.id ? 'translate-x-1' : ''
                    }`} />
                </div>
              </div>
            </div>
      ...
      <div className="relative max-w-4xl mx-auto mt-16 text-center">
        <Link to="/india" className="px-8 py-4 bg-gradient-to-r from-orange-500 to-orange-600 text-white font-semibold rounded-full shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300 flex items-center gap-3 mx-auto backdrop-blur-sm inline-flex">
